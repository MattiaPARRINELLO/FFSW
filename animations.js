/*
╔═══════════════════════════════════════════════════════════════════════════════════════╗
║                          ANIMATIONS FFSW - SYSTÈME UNIFIÉ                           ║
║                                  animations.js                                       ║
║                                                                                       ║
║  Description: Système d'animations optimisé compatible avec ffsw-scripts.js          ║
║  Fonctionnalités: Smooth scroll, écran de chargement, transitions de page            ║
╚═══════════════════════════════════════════════════════════════════════════════════════╝
*/
